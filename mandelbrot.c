...
int main()
{
	...
	/*
	unsigned char *colorR = (unsigned char *) malloc(iXmax*iYmax);
	unsigned char *colorG = (unsigned char *) malloc(iXmax*iYmax);
	unsigned char *colorB = (unsigned char *) malloc(iXmax*iYmax);

	unsigned char *R = colorR;
	unsigned char *G = colorG;
	unsigned char *B = colorB;*/
